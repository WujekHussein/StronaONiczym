"""
Django settings for StronaONiczym project.
...
SECRET_KEY = 'django-insecure-(8lg6@wru5t8(f6jm$#-q#!ka9x@3-ot9n0trfsa3v65p%&49)'
...
ROOT_URLCONF = 'StronaONiczym.urls'
...
WSGI_APPLICATION = 'StronaONiczym.wsgi.application'
